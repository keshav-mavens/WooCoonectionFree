...
class WooConnection_Front {
    ...
    public function wooconnection_leadsource_handling(){
    	//check if a request is php request also and ajax request then return true to prevent to go in next steps....
        if(isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
            return true;//return true it means stop to go in next code....
        }else if (isset($_REQUEST['add-to-cart'])) {
            return true;
        }
