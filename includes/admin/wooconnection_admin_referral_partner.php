...
<div class="righttextInner">
	...
	<div class="row">
        <div class="col-md-12 referral_partner_main_html">
			<?php if(empty($checkAuthenticationStatus)){
				...
				if(isset($checkReferralTrackingStatus) && !empty($checkReferralTrackingStatus)){
					$toggleValue = $checkReferralTrackingStatus;
				}
			?>
			<p class="text-right">
