...
class WooConnectionPro {
    ...
    public function create_thanks_page_override_table()
    {
        ...
        if($wpdb->get_var( "show tables like '$wooconnection_thankyou_override_related_products'" ) != $wooconnection_thankyou_override_related_products) 
        {
            ...
            $sqlOverrideProducts .= "  `wc_override_product_status` tinyint(4) DEFAULT 1 COMMENT '1-active,2-deleted',";
        ...
        if($wpdb->get_var( "show tables like '$wooconnection_thankyou_override_related_categories'" ) != $wooconnection_thankyou_override_related_categories) 
        {
            ...
            $sqlOverrideCat .= "  `wc_override_cat_status` tinyint(4) DEFAULT 1 COMMENT '1-active,2-deleted',";
