...
class WooConnectionPro {
    ...
    public function create_custom_fields_group_table()
    {
        global $table_prefix, $wpdb;
        $table_name = 'wooconnection_custom_field_groups';
        //create custom fields group table...
        $wp_custom_fields_group_table_name = $table_prefix . "$table_name";
        if($wpdb->get_var( "show tables like '$wp_custom_fields_group_table_name'" ) != $wp_custom_fields_group_table_name) 
        {
            $sqlGrp = "CREATE TABLE `". $wp_custom_fields_group_table_name . "` ( ";
            $sqlGrp .= "  `id`  int(11) NOT NULL auto_increment, ";
            $sqlGrp .= "  `wc_custom_field_group_name` varchar(255) NOT NULL, ";
            $sqlGrp .= "  `wc_custom_field_sort_order` int(11) DEFAULT NULL,";
            $sqlGrp .= "  `wc_custom_field_group_status` tinyint(4) DEFAULT 1 COMMENT '1-active,2-inactive,3-deleted',";
            $sqlGrp .= "  `created`  timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, ";
            $sqlGrp .= "  `modified`  timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, ";
            $sqlGrp .= "  PRIMARY KEY (`id`) ";
            $sqlGrp .= ") ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ; ";
            require_once( ABSPATH . '/wp-admin/includes/upgrade.php' );
            dbDelta($sqlGrp);
        }
        ...
        if($wpdb->get_var( "show tables like '$wooconnection_custom_fields'" ) != $wooconnection_custom_fields) 
        {
            $sqlCf = "CREATE TABLE `". $wooconnection_custom_fields . "` ( ";
            $sqlCf .= "  `id`  int(11) NOT NULL auto_increment, ";
            $sqlCf .= "  `wc_cf_group_id` int(11) NOT NULL, ";
            $sqlCf .= "  `wc_cf_name` varchar(255) NOT NULL, ";
            $sqlCf .= "  `wc_cf_type` tinyint(4) DEFAULT 1 COMMENT '1-text,2-textarea,3-dropdown,4-radio,5-checkbos,6-date',";
            $sqlCf .= "  `wc_cf_options` text DEFAULT NULL,";
            $sqlCf .= "  `wc_cf_default_value` varchar(255) DEFAULT NULL, ";
            $sqlCf .= "  `wc_cf_mandatory` tinyint(4) DEFAULT 2 COMMENT '1-yes,2-no',";
            $sqlCf .= "  `wc_cf_placeholder` varchar(255) DEFAULT NULL,";
            $sqlCf .= "  `wc_cf_mapped` text DEFAULT NULL, ";
            $sqlCf .= "  `wc_cf_mapped_field_type` tinyint(4) DEFAULT -1 COMMENT '-1-contact,-9-order', ";
            $sqlCf .= "  `wc_cf_sort_order` int(11) DEFAULT NULL,";
            $sqlCf .= "  `wc_cf_status` tinyint(4) DEFAULT 1 COMMENT '1-active,2-inactive,3-deleted',";
            $sqlCf .= "  `created`  timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, ";
            $sqlCf .= "  `modified`  timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, ";
            $sqlCf .= "  PRIMARY KEY (`id`) ";
    ...
    //Function Definition : create_standard_custom_fields_mapping_table
    ...
    //Function Definition : insert_campaign_goals_database_table
    public function create_thanks_page_override_table()
    {
        global $table_prefix, $wpdb;
        //create thankyou_overrides table...
        $wooconnection_thankyou_overrides = $table_prefix . "wooconnection_thankyou_overrides";
        if($wpdb->get_var( "show tables like '$wooconnection_thankyou_overrides'" ) != $wooconnection_thankyou_overrides) 
        {
            $sqlOverride = "CREATE TABLE `". $wooconnection_thankyou_overrides . "` ( ";
            $sqlOverride .= "  `id`  int(11) NOT NULL auto_increment, ";
            ...
            $sqlOverride .= "  `wc_override_status` tinyint(4) DEFAULT 1 COMMENT '1-active,2-inactive,3-deleted',";
            $sqlOverride .= "  `created`  timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, ";
            $sqlOverride .= "  `modified`  timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, ";
            $sqlOverride .= "  PRIMARY KEY (`id`) ";
            $sqlOverride .= ") ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ; ";
            require_once( ABSPATH . '/wp-admin/includes/upgrade.php' );
            dbDelta($sqlOverride);
        }


        //create override related products table
        $wooconnection_thankyou_override_related_products = $table_prefix . "wooconnection_thankyou_override_related_products";
        if($wpdb->get_var( "show tables like '$wooconnection_thankyou_override_related_products'" ) != $wooconnection_thankyou_override_related_products) 
        {
            $sqlOverrideProducts = "CREATE TABLE `". $wooconnection_thankyou_override_related_products . "` ( ";
            $sqlOverrideProducts .= "  `id`  int(11) NOT NULL auto_increment, ";
            $sqlOverrideProducts .= "  `override_id` int(11) NOT NULL, ";
            $sqlOverrideProducts .= "  `override_product_id` int(11) NOT NULL, ";
            $sqlOverrideProducts .= "  `wc_override_product_status` tinyint(4) DEFAULT 1 COMMENT '1-active,2-inactive,3-deleted',";
            $sqlOverrideProducts .= "  `created`  timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, ";
            $sqlOverrideProducts .= "  `modified`  timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, ";
            $sqlOverrideProducts .= "  PRIMARY KEY (`id`) ";
            $sqlOverrideProducts .= ") ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ; ";
            require_once( ABSPATH . '/wp-admin/includes/upgrade.php' );
            dbDelta($sqlOverrideProducts);
        }

        //create override related categories table
        $wooconnection_thankyou_override_related_categories = $table_prefix . "wooconnection_thankyou_override_related_categories";
        if($wpdb->get_var( "show tables like '$wooconnection_thankyou_override_related_categories'" ) != $wooconnection_thankyou_override_related_categories) 
        {
            $sqlOverrideCat = "CREATE TABLE `". $wooconnection_thankyou_override_related_categories . "` ( ";
            $sqlOverrideCat .= "  `id`  int(11) NOT NULL auto_increment, ";
            $sqlOverrideCat .= "  `override_id` int(11) NOT NULL, ";
            $sqlOverrideCat .= "  `override_cat_id` int(11) NOT NULL, ";
            $sqlOverrideCat .= "  `wc_override_cat_status` tinyint(4) DEFAULT 1 COMMENT '1-active,2-inactive,3-deleted',";
            $sqlOverrideCat .= "  `created`  timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, ";
            $sqlOverrideCat .= "  `modified`  timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, ";
            $sqlOverrideCat .= "  PRIMARY KEY (`id`) ";
            $sqlOverrideCat .= ") ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ; ";
            require_once( ABSPATH . '/wp-admin/includes/upgrade.php' );
