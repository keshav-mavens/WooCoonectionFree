...
class WooConnection {
  	...
  	public function __construct() {
        ...
        register_deactivation_hook( __FILE__, array($this,'delete_unwanted_data' ) );
    }
    ...
    //Function Definition : delete_unwanted_data this function is used delete the unwanted data..
